...
import { Typography, Row, Col, Statistic, Button, Divider, Spin  } from 'antd'
...
const Homepage: React.FC = () => {
        ...
        return (
                <>
                <section>
                        <Title level={1} className="">Coinview<wbr></wbr>.online</Title>
                        <Divider></Divider>
                </section>
                ...
                <section>
                        ...
                        <Col span={12}><Statistic title="Total Market Cap" value={ millify(parseInt(state.totalMarketCap))} /></Col>
                        <Col span={12}><Statistic title="Total 24h Volume" value={ millify( parseInt(state.total24hVolume))} /></Col>
